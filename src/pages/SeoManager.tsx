...
export default function SeoManager() {
  ...
  // Detect routes from the project's own App.tsx (latest revision) — this is
  // the actual source of truth for what pages exist, not a manually typed list.
  // Root ("/") is guaranteed to appear even if App.tsx's <Route> parsing misses
  // it for some reason — every app has a homepage, SEO-configurable by design.
  ...
  // Which routes already have a saved override — drives the status dot in the list.
  ...
  return (
    <div className="flex flex-col h-screen bg-black overflow-hidden">
      ...
      <Tabs defaultValue="pages" className="flex flex-col flex-1 min-h-0">
        <div className="px-4 pt-3 border-b border-white/[0.07] shrink-0">
