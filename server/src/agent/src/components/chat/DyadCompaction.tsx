...
import { VanillaMarkdownParser } from "./DyadMarkdownParser.js";
...
export const DyadCompaction: React.FC<DyadCompactionProps> = ({
  ...
  return (
    <div
      className={`relative rounded-lg border my-2 overflow-hidden transition-colors duration-300 ${inProgress
    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span
            className={`font-medium text-sm ${inProgress
