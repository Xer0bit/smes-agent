...
import { HistoryNavigation, HISTORY_TRIGGER } from "./HistoryNavigation.js";
...
>(({ selected, item, ...props }, ref) => {
  ...
  if (isHistory) {
    return (
      <li
        className={`m-0 px-3 py-2 cursor-pointer whitespace-nowrap overflow-hidden text-ellipsis ${selected
  ...
  return (
    ...
    >
      <div className="flex items-center space-x-2 min-w-0">
        <span
          className={`px-2 py-0.5 text-xs font-medium rounded-md flex-shrink-0 ${isSkill || isPrompt
