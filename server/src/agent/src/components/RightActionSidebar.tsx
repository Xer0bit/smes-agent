...
import { previewModeAtom, selectedAppIdAtom } from "../atoms/appAtoms.js";
import { Eye, Code, AlertTriangle, Wrench, Globe, Shield } from "lucide-react";
import { motion } from "framer-motion";
import { useCheckProblems } from "@/hooks/useCheckProblems";
import { isPreviewOpenAtom } from "@/atoms/viewAtoms";
import { useTranslation } from "react-i18next";
import type { PreviewMode } from "./preview_panel/ActionHeader.js";
...
export const RightActionSidebar = () => {
  ...
  const renderButton = (
    ...
    return (
      <button
        data-testid={testId}
        className={`no-app-region-drag cursor-pointer relative flex flex-col items-center justify-center w-12 h-12 rounded-lg font-medium transition-colors duration-150 active:scale-90 ${isActive
