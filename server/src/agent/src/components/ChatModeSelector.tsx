...
import { LocalAgentNewChatToast } from "./LocalAgentNewChatToast.js";
    ...
    <div className="flex items-center gap-1.5">
      ...
      >
                  ...
                  selectedMode === "build" || selectedMode === "local-agent"
                    ...
                    : selectedMode === "ask"
                      ...
                      : selectedMode === "plan"
                        ...
                        : selectedMode === "website-generator"
                          ? "bg-emerald-500/10 text-emerald-700 hover:bg-emerald-500/15 dark:bg-emerald-500/15 dark:text-emerald-400 dark:hover:bg-emerald-500/20"
                        : "text-foreground/80 hover:text-foreground hover:bg-muted/60",
                )}
                size="sm"
              />
        ...
        <SelectContent align="start">
          ...
          {isProEnabled && (
            <SelectItem value="website-generator">
              <div className="flex flex-col items-start">
                <div className="flex items-center gap-1.5">
                  <WandSparkles size={14} className="text-emerald-500" />
                  <span className="font-medium">Website Generator</span>
                  <NewBadge />
                </div>
                <span className="text-xs text-muted-foreground ml-[22px]">
                  Build complete websites end-to-end
                </span>
              </div>
            </SelectItem>
          )}
