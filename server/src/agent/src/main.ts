...
import { registerIpcHandlers } from "./ipc/ipc_host.js";
...
import { handleSupabaseOAuthReturn } from "./supabase_admin/supabase_return_handler.js";
import { handleDyadProReturn } from "./main/pro.js";
import { IS_TEST_BUILD } from "./ipc/utils/test_utils.js";
import { BackupManager } from "./backup_manager.js";
import { getDatabasePath, initializeDatabase } from "./db/index.js";
import { UserSettings } from "./lib/schemas.js";
import { handleNeonOAuthReturn } from "./neon_admin/neon_return_handler.js";
import {
  AddMcpServerConfigSchema,
  AddMcpServerPayload,
  AddPromptDataSchema,
  AddPromptPayload,
} from "./ipc/deep_link_data.js";
import {
  startPerformanceMonitoring,
  stopPerformanceMonitoring,
} from "./utils/performance_monitor.js";
import {
  stopAllAppsSync,
  stopAppGarbageCollection,
} from "./ipc/utils/process_manager.js";
import { cleanupOldAiMessagesJson } from "./pro/main/ipc/handlers/local_agent/ai_messages_cleanup.js";
import { cleanupOldMediaFiles } from "./ipc/utils/media_cleanup.js";
import fs from "fs";
import { gitAddSafeDirectory } from "./ipc/utils/git_utils.js";
import { getDyadAppsBaseDirectory, getDyadAppPath } from "./paths/paths.js";
import {
  DYAD_MEDIA_DIR_NAME,
  isWithinDyadMediaDir,
} from "./ipc/utils/media_path_utils.js";
