...
import { getEnvVar } from "./read_env.js";
import log from "electron-log";
import { FREE_OPENROUTER_MODEL_NAMES } from "../shared/language_model_constants.js";
import { getLanguageModelProviders } from "../shared/language_model_helpers.js";
import { resolveBuiltinModelAlias } from "../shared/remote_language_model_catalog.js";
import { LanguageModelProvider } from "@/ipc/types";
import {
  createDyadEngine,
  type DyadEngineProvider,
} from "./llm_engine_provider.js";

import { LM_STUDIO_BASE_URL } from "./lm_studio_utils.js";
import { createOllamaProvider } from "./ollama_provider.js";
import { getOllamaApiUrl } from "../handlers/local_model_ollama_handler.js";
import { createFallback } from "./fallback_ai_model.js";
  ...
  if (
    ...
    const fallbackModels = await Promise.all(
      AUTO_MODEL_ALIASES.map(async (aliasId) => {
        ...
        const resolvedModelId = `${resolvedProvider?.gatewayPrefix || ""
