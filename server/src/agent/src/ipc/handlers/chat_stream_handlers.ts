...
import { chatContracts } from "../types/chat.js";
import {
  ModelMessage,
  TextPart,
  ImagePart,
...
import type { SmartContextMode } from "../../lib/schemas.js";
import {
  constructSystemPrompt,
  readAiRules,
} from "../../prompts/system_prompt.js";
import { getThemePromptById } from "../utils/theme_utils.js";
import {
  getSupabaseAvailableSystemPrompt,
  SUPABASE_NOT_AVAILABLE_SYSTEM_PROMPT,
} from "../../prompts/supabase_prompt.js";
import { getDyadAppPath } from "../../paths/paths.js";
import { buildDyadMediaUrl } from "../../lib/dyadMediaUrl.js";
import { readSettings } from "../../main/settings.js";
...
import {
  ...
  extractCodebase,
  readFileWithCache,
} from "../../utils/codebase.js";
import {
  dryRunSearchReplace,
  processFullResponseActions,
} from "../processors/response_processor.js";
import { streamTestResponse } from "./testing_chat_handlers.js";
import { getTestResponse } from "./testing_chat_handlers.js";
import { getModelClient, ModelClient } from "../utils/get_model_client.js";
import log from "electron-log";
import { sendTelemetryEvent } from "../utils/telemetry.js";
import {
  getSupabaseContext,
  getSupabaseClientCode,
} from "../../supabase_admin/supabase_context.js";
import { SUMMARIZE_CHAT_SYSTEM_PROMPT } from "../../prompts/summarize_chat_system_prompt.js";
import { SECURITY_REVIEW_SYSTEM_PROMPT } from "../../prompts/security_review_prompt.js";
import fs from "node:fs";
import * as path from "path";
import * as crypto from "crypto";
import { readFile, writeFile } from "fs/promises";
import { getMaxTokens, getTemperature } from "../utils/token_utils.js";
import { MAX_CHAT_TURNS_IN_CONTEXT } from "@/constants/settings_constants";
import { validateChatContext } from "../utils/context_paths_utils.js";
import { getProviderOptions, getAiHeaders } from "../utils/provider_options.js";
import { mcpServers } from "../../db/schema.js";
import { requireMcpToolConsent } from "../utils/mcp_consent.js";

import { handleLocalAgentStream } from "../../pro/main/ipc/handlers/local_agent/local_agent_handler.js";

import { safeSend } from "../utils/safe_sender.js";
import {
  cleanFullResponse,
  normalizeLegacyEcomgearTags,
} from "../utils/cleanFullResponse.js";
import { generateProblemReport } from "../processors/tsc.js";
import { createProblemFixPrompt } from "@/shared/problem_prompt";
import { AsyncVirtualFileSystem } from "../../../shared/VirtualFilesystem.js";
import { escapeXmlAttr, escapeXmlContent } from "../../../shared/xmlEscape.js";
import {
  getDyadAddDependencyTags,
  getDyadWriteTags,
  getDyadDeleteTags,
  getDyadRenameTags,
} from "../utils/dyad_tag_parser.js";
import { fileExists } from "../utils/file_utils.js";
import { extractMentionedAppsCodebases } from "../utils/mention_apps.js";
...
import { replacePromptReference } from "../utils/replacePromptReference.js";
import { replaceSlashSkillReference } from "../utils/replaceSlashSkillReference.js";
import { resolveMediaMentions } from "../utils/resolve_media_mentions.js";
import { parsePlanFile, validatePlanId } from "./planUtils.js";
import { ensureDyadGitignored } from "./gitignoreUtils.js";
import { DYAD_MEDIA_DIR_NAME } from "../utils/media_path_utils.js";
import { mcpManager } from "../utils/mcp_manager.js";
import z from "zod";
import {
  isBasicAgentMode,
  isSupabaseConnected,
...
} from "./free_agent_quota_handlers.js";
import { AI_STREAMING_ERROR_MESSAGE_PREFIX } from "@/shared/texts";
import { getCurrentCommitHash } from "../utils/git_utils.js";
import {
  processChatMessagesWithVersionedFiles as getVersionedFiles,
  VersionedFiles,
} from "../utils/versioned_codebase_context.js";
import { getAiMessagesJsonIfWithinLimit } from "../utils/ai_messages_utils.js";
      ...
      if (testResponse) {
        ...
        const willUseLocalAgentStream =
          (settings.selectedChatMode === "local-agent" ||
            settings.selectedChatMode === "website-generator" ||
...
`;
        ...
        // Handle website-generator mode
        // Website generator uses local-agent infrastructure with a dedicated system prompt profile.
        if (
          settings.selectedChatMode === "website-generator" &&
          !mentionedAppsCodebases.length
        ) {
...
export function removeDyadTags(text: string): string {
  ...
  return normalizedText.replace(dyadRegex, "").trim();
}
...
export function hasUnclosedDyadWrite(text: string): boolean {
  ...
  while ((match = openRegex.exec(normalizedText)) !== null) {
  ...
  const textAfterLastOpen = normalizedText.substring(lastOpenIndex);
