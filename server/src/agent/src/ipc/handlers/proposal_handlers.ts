...
// Import tag parsers
import { processFullResponseActions } from "../processors/response_processor.js";
import {
  getDyadWriteTags,
  getDyadRenameTags,
  getDyadDeleteTags,
...
import { isServerFunction } from "../../supabase_admin/supabase_utils.js";
import {
  estimateMessagesTokens,
  estimateTokens,
  getContextWindow,
} from "../utils/token_utils.js";
import { extractCodebase } from "../../utils/codebase.js";
...
const approveProposalHandler = async (
  ...
  if (
    ...
    throw new Error(
      "Proposal approval is only supported in build mode. Please switch to build mode.",
    );
  }
