...
const HEALTH_STYLES: Record<string, { color: string; icon: React.ElementType }> = {
  ...
  unknown:      { color: 'text-muted-foreground', icon: WifiOff },
};
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Manage hosting VPS nodes for tenant deployments</p>
        </div>
      ...
      <Card className="bg-white/[0.02] border-white/[0.06]">
        <CardHeader>
          <CardTitle className="text-base text-white flex items-center gap-2">
            <Server className="h-4 w-4 text-muted-foreground" /> Registered Servers
          </CardTitle>
        </CardHeader>
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-12 text-muted-foreground">
              ...
              <Button size="sm" className="mt-4 bg-primary hover:bg-primary/90" onClick={() => setShowAdd(true)}>
            ...
            <Table>
              <TableHeader>
                <TableRow className="border-white/[0.06] hover:bg-transparent">
                  ...
                  <TableHead className="text-muted-foreground">IP / Port</TableHead>
                ...
                {servers.map((s) => {
                  ...
                  return (
                    <TableRow key={s.id} className="border-white/[0.04] hover:bg-white/[0.02]">
                      ...
                      <TableCell className="text-muted-foreground font-mono text-xs">{s.public_ip}:{s.api_port}</TableCell>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs text-muted-foreground">{s.capacity_used}/{s.capacity_total}</span>
                        </div>
                      </TableCell>
      ...
      <Dialog open={showAdd} onOpenChange={setShowAdd}>
        <DialogContent className="sm:max-w-lg bg-[hsl(var(--admin-surface))] border-white/10">
          ...
          <div className="space-y-4 py-2">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <Label className="text-muted-foreground text-xs">Server Name</Label>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="space-y-1.5">
                <Label className="text-muted-foreground text-xs">API Port</Label>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <Label className="text-muted-foreground text-xs">API Key (Bearer Token)</Label>
              ...
              <div className="space-y-1.5">
                <Label className="text-muted-foreground text-xs">Max Tenants</Label>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleAdd} disabled={saving} className="bg-primary hover:bg-primary/90">
