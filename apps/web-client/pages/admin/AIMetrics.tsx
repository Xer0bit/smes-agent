...
const TIER_STYLES: Record<Tier, { dot: string; pill: string }> = {
  ...
  fix: { dot: 'bg-primary', pill: 'bg-muted text-muted-foreground border-border' },
  edit: { dot: 'bg-primary', pill: 'bg-muted text-muted-foreground border-border' },
...
function StatCard({
  ...
  return (
    <div className="rounded-none border border-white/[0.06] bg-[hsl(var(--admin-surface))] p-5">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard title="Total Runs" value={monthRuns.toLocaleString()} trend={runsTrend} icon={Activity} iconColor="text-muted-foreground" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        />
        <div className="rounded-none border border-white/[0.06] bg-[hsl(var(--admin-surface))] p-5 md:col-span-2">
          <div className="flex items-center justify-between mb-3">
      ...
      {/* Token cap warning */}
      {capHits > 0 && (
        <div className="rounded-none border border-amber-500/20 bg-amber-500/[0.04] p-4 flex items-center gap-3">
